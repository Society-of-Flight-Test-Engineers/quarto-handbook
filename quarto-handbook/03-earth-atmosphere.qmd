...
| radius as a function of latitude, $\phi$   (assumes perfect ellipsoid) |             | \begin{equation*}
R = \sqrt{\left(\frac{\cos{\phi}}{R_e}\right)^2 + \left(\frac{\sin{\phi}}{R_p}\right)^2} 
\end{equation*}|           |
